            ...
            <div class="booking mt-4 tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab"
                ...
                <div style="border:1px solid black" class="mb-3">
                    ...
                    <p style="font-weight:bolder;font-size:1vh;font-size:1vw" class="text-start mt-3 ms-3"> Thời
                        gian
                        tạo: {{
                        \Carbon\Carbon::parse($book->created_at)->format('d-m-Y H:i:s') }}</p>
                    <div class=" align-items-center d-flex justify-content-center ms-3 me-3">
                        <form style="width:100%;font-size:1.5vh;font-size:1.5vw" method="post"
                            ...
                            <div class="Date">
                                <p>Chọn lịch</p>
                                <input name="date" class="form-control" placeholder="Nhập lịch" value="{{
                        \Carbon\Carbon::createFromTimestamp((int)$book->date)->format('Y-m-d\TH:i') }}" required
                                    type="datetime-local">
                            </div>
                            <div class="form-group">
