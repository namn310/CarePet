...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            @if ($roleAccount !== 'admin')
            <li class="nav-item">
                <a style="font-size:1.5vw;font-size:1.5vh" class="nav-link "
                    href="{{ route('admin.ListScheduleRoleStaff') }}">
            ...
            <li class="nav-item">
                <a style="font-size:1.5vw;font-size:1.5vh" class="nav-link " href="{{ route('admin.posts') }}">
